...
export default function Contato() {
    ...
    const inserir = () => {
        fetch('http://127.0.0.1:8000/api/postContato', {
            method: 'post',
            headers: {
    ...
    return (
        <View style={styles.container}>
            ...
            <TextInput placeholder="Mensagem" multiline={true} rows={3} style={styles.input} onChangeText={text => setMensagem(text)}/>
            ...
            <Modal visible={contatoVisible} animationType="fade">
                ...
                <View style={styles.containermodal}>
                    ...
                    <FlatList
                        data={data}
                        keyExtractor = {({idContato}, index) => idContato}
